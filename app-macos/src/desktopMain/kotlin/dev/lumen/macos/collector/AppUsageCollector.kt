...
/**
 * PROPOSED SEAM — belongs in `core/src/commonMain/.../collector/`, which is
 * Agent A's zone and frozen at M1.
 *
 * It lives here temporarily so the macOS collector has something to compile
 * against and so the proposal comes with a working implementation rather than
 * a sketch. Delete this file and import from core once Agent A lands it.
 *
 * Every platform collector implements this: Hyprland/Sway/X11 (Agent A),
 * Android UsageStats (Agent A), macOS NSWorkspace (Agent B).
 *
